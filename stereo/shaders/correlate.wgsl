...
fn main(@builtin(global_invocation_id) global_id: vec3u) {
    ...
    let a_0: cmat4 = cmat4(kernel_a.r, kernel_a.g);
    let a_1: cmat4 = cmat4(kernel_a.b, mat4x4f()); // waste a channel :|
    let b_0: cmat4 = cmat4(kernel_b.r, kernel_b.g);
    let b_1: cmat4 = cmat4(kernel_b.b, mat4x4f());
    ...
    correlation_kernels[feature_idx].correlation = xcor;
}
