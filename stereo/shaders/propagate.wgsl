...
@group(1) @binding(0) var<storage, read> src_nodes_t0_d0:        array<TreeNode>;
...
fn main(@builtin(global_invocation_id) global_id: vec3u) {
    ...
    let src_parent_node:   TreeNode = src_nodes_t0_d0[src_feature_idx];
    ...
    for (var i: u32 = first_child_idx; i < end_child_idx; i++) {
        ...
        // not handled: process noise; time prediction
